...
from refactor_code.outputs.report.pyvista_render_settings.engine3_proposals import (
    ENGINE3_PROPOSALS_RENDER_SETTINGS,
)
from refactor_code.outputs.report.pyvista_render_settings.shared import (
