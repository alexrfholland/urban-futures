...
Usage:
    python _code-refactored/refactor_code/outputs/report/a_info_pathway_tracking_graphs.py
    python _code-refactored/refactor_code/outputs/report/a_info_pathway_tracking_graphs.py --sites city,uni
"""
...
from refactor_code.outputs.report.render_proposal_schema_v3 import PROPOSAL_HEX
