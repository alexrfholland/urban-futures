...
from refactor_code.paths import (
    tree_library_resource_counts_path,
    tree_template_base_root,
    tree_template_combined_edits_path,
    tree_template_resource_dict_path,
)
def load_files():
    ...
    # Define paths
    template_dir = tree_template_base_root()
    ...
    resourceDFPath = tree_template_resource_dict_path()
...
def analyze_all_resource_counts(templates_df):
    ...
    # Export to CSV
    output_path = tree_library_resource_counts_path()
...
def main():
    ...
    """
    #manual edits
    allTreeEdits = pd.read_pickle(tree_template_combined_edits_path())
