...
for import_root in (BLENDER_EXPORT_DIR, FINAL_DIR, CODE_ROOT):
...
from refactor_code.paths import (
    ...
    tree_mesh_ply_dir,
    tree_mesh_vtk_dir,
    tree_template_overrides_applied_path,
    tree_template_selected_overrides_path,
)
...
if __name__ == "__main__":
    ...
    if user_input in [1, 3]:
        ...
        input_folder = str(tree_mesh_vtk_dir())
        output_folder = str(tree_mesh_ply_dir())
        ...
        input_folder = str(log_mesh_vtk_dir())
        output_folder = str(log_mesh_ply_dir())
        ...
        input_folder = tree_mesh_vtk_dir()
        output_folder = tree_mesh_ply_dir()
        refactored_output_folder = hook_tree_ply_library_dir()
        
        justEditsDF = pd.read_pickle(tree_template_selected_overrides_path())
        ...
        templatesDF = pd.read_pickle(tree_template_overrides_applied_path())
