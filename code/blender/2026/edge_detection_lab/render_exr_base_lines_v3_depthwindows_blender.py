...
OUTPUT_DIR = REPO_ROOT / "data" / "blender" / "2026" / "edge_detection_lab" / "outputs" / "exr_city_blender_base_lines_v3_depthwindows"
BLEND_PATH = REPO_ROOT / "data" / "blender" / "2026" / "edge_detection_lab" / "exr_city_blender_base_lines_v3_depthwindows.blend"
...
VARIANT_SPECS = (
    {
        "name": "base_depth_windowed_balanced",
        "ground_filter": "SOBEL",
        "building_windows": (
            {"min_depth": 88.0, "max_depth": 150.0, "filter": "KIRSCH", "low": 0.020, "high": 0.070, "core": 1, "wide": 1, "blur": 1},
            {"min_depth": 135.0, "max_depth": 250.0, "filter": "KIRSCH", "low": 0.035, "high": 0.095, "core": 1, "wide": 1, "blur": 1},
        ),
        "ground_window": {"min_depth": 88.0, "max_depth": 240.0, "low": 0.045, "high": 0.120, "core": 0, "wide": 0, "blur": 1},
        "ground_core": 0,
        "ground_wide": 0,
        "blur": 1,
    },
    {
        "name": "base_depth_windowed_internal",
        "ground_filter": "SOBEL",
        "building_windows": (
            {"min_depth": 88.0, "max_depth": 142.0, "filter": "KIRSCH", "low": 0.016, "high": 0.058, "core": 1, "wide": 1, "blur": 1},
            {"min_depth": 128.0, "max_depth": 210.0, "filter": "KIRSCH", "low": 0.028, "high": 0.078, "core": 1, "wide": 1, "blur": 1},
            {"min_depth": 195.0, "max_depth": 320.0, "filter": "SOBEL", "low": 0.040, "high": 0.105, "core": 0, "wide": 1, "blur": 1},
        ),
        "ground_window": {"min_depth": 88.0, "max_depth": 260.0, "low": 0.050, "high": 0.135, "core": 0, "wide": 0, "blur": 1},
        "ground_core": 0,
        "ground_wide": 0,
        "blur": 1,
    },
    {
        "name": "base_depth_windowed_bold",
        "ground_filter": "KIRSCH",
        "building_windows": (
            {"min_depth": 88.0, "max_depth": 165.0, "filter": "KIRSCH", "low": 0.018, "high": 0.062, "core": 1, "wide": 2, "blur": 1},
            {"min_depth": 150.0, "max_depth": 300.0, "filter": "KIRSCH", "low": 0.030, "high": 0.085, "core": 1, "wide": 1, "blur": 1},
        ),
        "ground_window": {"min_depth": 88.0, "max_depth": 300.0, "low": 0.040, "high": 0.100, "core": 0, "wide": 1, "blur": 1},
        "ground_core": 0,
        "ground_wide": 1,
        "blur": 1,
    },
...
def log(message: str) -> None:
    print(f"[render_exr_base_lines_v3_depthwindows_blender] {message}")
