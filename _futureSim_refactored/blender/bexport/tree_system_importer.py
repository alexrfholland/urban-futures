...
from _futureSim_refactored.paths import scenario_tree_df_path, tree_mesh_ply_dir
...
CSV_FILENAME = f'{SITE}_{SCENARIO}_1_treeDF_{YEAR}.csv'
CSV_FILEPATH = str(scenario_tree_df_path(SITE, SCENARIO, YEAR))
BASE_PATH = str(Path(CSV_FILEPATH).parent)
PLY_FOLDER = str(tree_mesh_ply_dir())
