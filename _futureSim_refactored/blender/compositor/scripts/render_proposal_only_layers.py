...
EXR_PATH = Path(
    os.environ.get(
        "COMPOSITOR_PROPOSAL_ONLY_EXR",
        str(DEFAULT_EXR),
    )
).expanduser()
OUTPUT_DIR = Path(
    os.environ.get(
        "COMPOSITOR_PROPOSAL_ONLY_OUTPUT_DIR",
        str(OUTPUT_BASE / "proposal_only_layers"),
    )
).expanduser()
BLEND_PATH = Path(
    os.environ.get(
        "COMPOSITOR_PROPOSAL_ONLY_BLEND",
        str(CANONICAL_ROOT / "proposal_only_layers.blend"),
    )
).expanduser()
