"""Fast runner for proposal_outline_layers.blend.
...
NAME = "render_current_proposal_outline"
BLEND_DEFAULT = CANONICAL_ROOT / "proposal_outline_layers.blend"
...
def main() -> None:
    ...
    scene = os.environ.get("COMPOSITOR_SCENE_NAME", "ProposalOutline")
    ...
    config = FastRunnerConfig(
        ...
        file_output_node="ProposalOutlineOutput",
        output_dir=Path(out),
    )
