"""Fast runner for size_outline_layers.blend.
...
NAME = "render_current_size_outline"
BLEND_DEFAULT = CANONICAL_ROOT / "size_outline_layers.blend"
...
def main() -> None:
    ...
    scene = os.environ.get("COMPOSITOR_SCENE_NAME", "SizeOutline")
    ...
    config = FastRunnerConfig(
        ...
        file_output_node="SizeOutlineOutput",
        output_dir=Path(out),
    )
