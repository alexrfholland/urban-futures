"""Fast runner for compositor_mist.blend.
...
NAME = "render_current_mist"
BLEND_DEFAULT = CANONICAL_ROOT / "compositor_mist.blend"
...
def main() -> None:
    ...
    config = FastRunnerConfig(
        ...
        scene_name=scene,
        exr_inputs={"MistOutlines::EXR Input": Path(exr)},
        file_output_node="MistOutlines::Outputs",
        output_dir=Path(out),
