...
from _futureSim_refactored.sim.generate_interim_state_data.engine_v3 import calculate_under_node_treatment_status
...
from _futureSim_refactored.sim.voxel import voxel_a_voxeliser as a_voxeliser
...
from _futureSim_refactored.blender.bexport.proposal_framebuffers import build_blender_proposal_framebuffer_columns
from _futureSim_refactored.blender.bexport.proposal_framebuffers_vtk import build_blender_proposal_framebuffer_arrays
...
def assign_v4_proposals_from_bioenvelope(ds):
    ...
    if 'proposal_recruit' in ds.variables:
        ...
        recruitInterventionFULL = unset & np.isin(bio_envelope, ["node-rewilded", "footprint-depaved-connected", "otherground", "rewilded"])
...
if __name__ == "__main__":
    from _futureSim_refactored.sim.setup import a_scenario_initialiseDS
