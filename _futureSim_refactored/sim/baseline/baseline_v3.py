...
from _futureSim_refactored.sim.voxel import voxel_a_helper_functions as a_helper_functions  # noqa: E402
from _futureSim_refactored.input_processing.tree_processing import a_resource_distributor_dataframes  # noqa: E402

from _futureSim_refactored.blender.bexport.proposal_framebuffers import build_blender_proposal_framebuffer_columns  # noqa: E402
from _futureSim_refactored.blender.bexport.proposal_framebuffers_vtk import build_blender_proposal_framebuffer_arrays  # noqa: E402
...
from _futureSim_refactored.sim.setup.structure_ids import assign_baseline_tree_structure_ids  # noqa: E402
from _futureSim_refactored.sim.setup.constants import (  # noqa: E402
...
BASELINE_DENSITY_CSV = REPO_ROOT / "_data-refactored" / "model-inputs" / "shared" / "tree-baseline-density.csv"
...
def require_tree_template_root(template_root: str | Path | None = None) -> Path:
    ...
    if not configured:
        from _futureSim_refactored.paths import tree_template_root
