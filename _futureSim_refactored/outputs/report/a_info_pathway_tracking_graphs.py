...
Usage:
    python _futureSim_refactored/outputs/report/a_info_pathway_tracking_graphs.py
    python _futureSim_refactored/outputs/report/a_info_pathway_tracking_graphs.py --sites city,uni
"""
...
from _futureSim_refactored.paths import normalize_output_mode, refactor_statistics_root
from _futureSim_refactored.outputs.report.render_proposal_schema_v3 import PROPOSAL_HEX
