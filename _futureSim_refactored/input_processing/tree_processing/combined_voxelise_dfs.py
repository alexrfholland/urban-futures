...
def adjust_resource_quantities(voxelised_templates, resource_dic_path=None):
    """Adjust resource quantities in voxelized templates to match target percentages."""
    resource_dic_path = Path(resource_dic_path) if resource_dic_path else tree_template_resource_dict_path()
...
def generate_resource_stats(voxelised_templates, resource_dic_path=None, output_dir=None):
    """
    ...
    output_dir = Path(output_dir) if output_dir else tree_template_base_root()
...
def generate_all_resource_stats(voxelised_templates, output_dir=None):
    """
...
if __name__ == "__main__":
    ...
    # combined_templates = pd.read_pickle('_data-refactored/model-inputs/tree_libraries/base/trees/template-library.base.pkl')
    combined_templates = pd.read_pickle('_data-refactored/model-inputs/tree_libraries/base/trees/template-library.overrides-applied.pkl')
