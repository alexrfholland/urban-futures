...
_futureSim_refactored/sim/run/v4-run-instructions.md.
"""
...
REPO_ROOT = next(parent for parent in Path(__file__).resolve().parents if parent.name == "_futureSim_refactored").parent
...
from _futureSim_refactored.input_processing.tree_processing import aa_tree_helper_functions  # noqa: E402
from _futureSim_refactored.input_processing.tree_processing import combine_resource_treeMeshGenerator  # noqa: E402
from _futureSim_refactored.input_processing.tree_processing import combined_redoSnags  # noqa: E402
from _futureSim_refactored.input_processing.tree_processing import combined_tree_manager  # noqa: E402
from _futureSim_refactored.input_processing.tree_processing import combined_voxelise_dfs  # noqa: E402
from _futureSim_refactored.paths import tree_template_base_root, tree_template_variants_root  # noqa: E402
