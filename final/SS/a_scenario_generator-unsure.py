...
def assign_logs(logDF, params):
    #TODOLOG
    resistanceThreshold = params['sim_TurnsThreshold'][params['years_passed']]
    turnThreshold = params['sim_averageResistance'][params['years_passed']]
...
def process_scenarios(site, voxel_size):
    ...
    paramsDic = {'trimmed-parade' : paramsPARADE,
                 'city' : paramsCITY}
    
    params = paramsDic[site]
    ...
    for year in years_passed:
        ...
        treeDF_scenario, logDF_scenario = run_simulation(treeDF.copy(), subsetDS, params, logDF)
        ...
        ds, combinedDF_scenario = a_voxeliser.integrate_resources_into_xarray(ds, treeDF_scenario, logDF_scenario, valid_points)
        ...
        combinedDF_scenario.to_csv(f'{filePATH}/{site}_{voxel_size}_nodeDF_{year}.csv', index=False)
