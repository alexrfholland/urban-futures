...
def calculate_and_add_inclination_angle(df): #TODO GET THIS WORKING
...
if __name__ == "__main__":
    ...
    input_folder = 'data/revised/lidar scans/elm/treeQSM'
    output_folder_template = 'data/revised/tree_processedInputs'
