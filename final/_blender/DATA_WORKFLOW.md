...
1. `final/tree_processing/combine_resource_treeMeshGenerator.py`
   - reads `data/revised/trees/edited_combined_templateDF.pkl` or `data/revised/trees/just_edits_templateDF.pkl`
...
2. `final/tree_processing/combined_tree_manager.py`
   ...
   - writes `data/revised/trees/edited_combined_templateDF.pkl`
   - writes `data/revised/trees/just_edits_templateDF.pkl`
