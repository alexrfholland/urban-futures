...
def run_simulation(grid_data):
    ...
    for roof_id in unique_roof_ids:
        ...
        while remaining_roof_load > 0 and (len(growth_stack) > 0):
            ...
            if not active_growth_nodes and remaining_roof_load > 0:
...
def get_bioenvelopes(site, xarray_dataset, grouped_roof_info):
    ...
    update_roof_grouped_info(grouped_roof_info, grid_data, greenPlants, brownPlants, greenFacades, INPUTFOLDER, site)
