...
# CITY-ONLY CAMERA ITERATION SCRIPT.
# Run this inside the prepared debug blend when you want a tighter city zoom
# based on the actual rendered alpha silhouette rather than raw geometry bounds.


OUTPUT_DIR = Path(r"D:\2026 Arboreal Futures\data\renders\timeslices\camera_tests")
OUTPUT_IMAGE_NAME = "city-visible-zoom-test-v7.png"
SCENE_NAME = "city"
VIEW_LAYER_NAME = "debug_camera_framing"
SOURCE_CAMERA_NAME = "city_good_zoomed_timeslice_cam"
...
def main() -> None:
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        print(f"CITY_VISIBLE_ZOOM_TEST iteration={iteration}")
        print(
            "  bbox_px="
    ...
    print(f"CITY_VISIBLE_ZOOM_TEST_FINAL {target_camera.name}")
