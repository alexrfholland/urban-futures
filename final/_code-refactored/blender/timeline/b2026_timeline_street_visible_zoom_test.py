...
# STREET-ONLY CAMERA ITERATION SCRIPT.
# Run this inside the prepared debug blend when you want a tighter street zoom
# based on the rendered alpha silhouette.


OUTPUT_DIR = Path(r"D:\2026 Arboreal Futures\data\renders\timeslices\camera_tests")
OUTPUT_IMAGE_NAME = "street-visible-zoom-test-v6.png"
SCENE_NAME = "street"
...
def main() -> None:
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        print(f"STREET_VISIBLE_ZOOM_TEST iteration={iteration}")
        print(
            "  bbox_px="
    ...
    print(f"STREET_VISIBLE_ZOOM_TEST_FINAL {target_camera.name}")
